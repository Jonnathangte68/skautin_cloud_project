...
@section('content')
    ...
    <div class="row">
      ...
      <div class="col-md-4 .col-sm-10 .col-10 box-detopciones">
            ...
            <!-- Form Name -->
            <legend><a href="{{route('account_settings')}}"><i class="fas fa-arrow-circle-left" style="color:black;font-size: 35px;"></i></a><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Edit User Account!</span></legend>
                <div class="row">
                    <div class="col-md-2"></div>
                    <div class="col-md-4"><a href="/view-edit-my-profile" class="btn btn-primary" style="width: 100%;font-weight: bold;">View Public Profile</a></div>
...
@section('scripts')
    <script type="text/javascript">
        ...
        var imgp = String("<?= $data['userdata']->profile_img; ?>");
