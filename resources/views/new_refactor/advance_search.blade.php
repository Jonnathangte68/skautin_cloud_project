...
<input type="hidden" id="advanced_search" value="true" />
...
<div class="row row-alta">
		...
		<div class="col-md-4">
			...
			<!-- Select Basic -->
			<div id="age-range-select" class="form-group elemsearch">
			  <div class="col-md-12">
			...
			<!-- Select Basic -->
			<div id="experience-select-container" class="form-group elemsearch">
			  <div class="col-md-12">
			...
			<div class="col-md-12" style="margin-top:15px;">
				<a onclick="resetFields()" class="bluelnk">clear filters</a>
			</div>
	</div>
