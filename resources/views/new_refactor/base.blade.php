...
<head>
	...
	@yield('head')
	<style>.left_add_user{width:1.9rem}.rigth_add_user{width:1.9rem;float:right;clear:both}.inner_card_body{padding:5%}.popover{width:650px!important}.popover-title{text-align:center;font-weight:700}.popover-content{height:365px;overflow-y:auto;overflow-x:hidden;padding-left:10%;padding-right:10%}.no-padd{padding-left:2px;padding-right:0;padding-top:0;padding-bottom:0}.img-notif{width:100%;border-radius:50%}.advanced-search-text{position:absolute;top:18px;left:58%}.search{left:14%;width:21%;margin-top:5px!important}.search svg{left:17px!important;top:14px}#prependedtext{margin-left:0!important}</style>
	<style>
		.scrollbar-without-scroll::-webkit-scrollbar {
			overflow-y: auto;
			display: none;
		}
		.scrollbar-without-scroll {
			overflow-y: auto;
