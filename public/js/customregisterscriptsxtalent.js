function clearForm() {
    ...
    $('#category').css('border-color', 'rgb(204, 204, 204)');
    $('#subcategory').css('border-color', 'rgb(204, 204, 204)');
    $('#level').css('border-color', 'rgb(204, 204, 204)');
    return 1;
}
...
function errorHandler(error) {
    switch (error) {
        ...
        case 10:
            ...
            $('#fill_add_wrong_items').append("<p>* Please select at least One category!</p>");
            $('#category').focus();
            break;
        case 11:
            $('#subcategory').css('border-color', 'red');
            $('#fill_add_wrong_items').append("<p>* Please select at least One Subcategory!</p>");
            $('#subcategory').focus();
            break;
        case 12:
